...
int uniqueId=7;
    ...
    public ArrayList<Employee> getEmployees(){
        Collection<Employee> employeesValues = employeeList.values();
        ArrayList<Employee> employees = new ArrayList<>(employeesValues);
        return employees;
    }
    ...
    public Employee addEmployee(Employee employee){
        ...
        Employee employee1 = employeeList.get(uniqueId);
        uniqueId+=1;
        return employee1;
